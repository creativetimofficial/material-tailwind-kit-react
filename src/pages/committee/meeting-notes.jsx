        ...
        <div className="container relative mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="mx-auto w-full px-4 text-center lg:w-8/12">
              ...
              >
                Get all the discussions and action items from meetings!
              </Typography>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full px-4 lg:w-3/5">
              <Card className="shadow-lg p-6">
                ...
                >
                  All our meeting notes from the committee organised meetings will be listed here!
                </Typography>
              </Card>
            </div>
