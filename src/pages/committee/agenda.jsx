        ...
        <div className="container relative mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="mx-auto w-full px-4 text-center lg:w-8/12">
              ...
              >
                Discover our upcoming plans and activities. Stay tuned for updates!
              </Typography>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full px-4 lg:w-3/5">
              <Card className="shadow-lg p-6">
                ...
                >
                  Our agenda will be updated shortly with all the exciting events, meetings, and initiatives we have planned. Please check back soon to see how you can get involved!
                </Typography>
              </Card>
            </div>
